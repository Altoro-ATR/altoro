...
public class VMConfig {
  ...
  public static org.altoro.core.vm.config.VMConfig getInstance() {
  ...
  private static class SystemPropertiesInstance {
    ...
    private static final org.altoro.core.vm.config.VMConfig INSTANCE = new org.altoro.core.vm.config.VMConfig();
  }
}
