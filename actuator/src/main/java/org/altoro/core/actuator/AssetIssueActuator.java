...
import org.altoro.protos.contract.AssetIssueContractOuterClass.AssetIssueContract.FrozenSupply;
...
public class AssetIssueActuator extends AbstractActuator {
  ...
  public boolean validate() throws ContractValidateException {
    ...
    if (dynamicStore.getAllowSameTokenName() != 0) {
      ...
      if (("atr").equals(name)) {
        throw new ContractValidateException("assetName can't be atr");
      }
    }
