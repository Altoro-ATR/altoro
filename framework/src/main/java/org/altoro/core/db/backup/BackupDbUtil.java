package org.altoro.core.db.backup;
...
import org.altoro.core.db2.core.SnapshotRoot;
  ...
  private void backup(int i) throws RocksDBException {
    ...
    for (Chainbase store : stores) {
      if (((SnapshotRoot) (store.getHead().getRoot())).getDb().getClass()
              == org.altoro.core.db2.common.RocksDB.class) {
        ((org.altoro.core.db2.common.RocksDB) ((SnapshotRoot) (store.getHead().getRoot())).getDb())
                .getDb().backup(path);
      }
    }
  }
