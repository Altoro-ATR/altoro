package org.altoro.core.zen.note;
...
import org.altoro.core.utils.ZenChainParams;
import org.altoro.core.zen.address.DiversifierT;
import org.altoro.core.zen.note.NoteEncryption.Encryption.EncCiphertext;
import org.altoro.core.zen.note.NoteEncryption.Encryption.EncPlaintext;
import org.altoro.core.zen.note.NoteEncryption.Encryption.OutCiphertext;
import org.altoro.core.zen.note.NoteEncryption.Encryption.OutPlaintext;
...
import static org.altoro.core.utils.ZenChainParams.*;
import static org.altoro.core.zen.note.NoteEncryption.Encryption.NOTEENCRYPTION_CIPHER_KEYSIZE;
...
public class NoteEncryption {
  ...
  public Optional<EncCiphertext> encryptToRecipient(byte[] pkD, EncPlaintext message)
    ...
    byte[] cipherNonce = new byte[JLibsodium.CRYPTO_AEAD_CHACHA20POLY1305_IETF_NPUBBYTES];
