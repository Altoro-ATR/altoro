...
public class NetInfo {
  ...
  private List<org.altoro.core.metrics.net.DisconnectionDetailInfo> disconnectionDetail = new ArrayList<>();
  ...
  public List<org.altoro.core.metrics.net.DisconnectionDetailInfo> getDisconnectionDetail() {
    return disconnectionDetail;
  }

  public void setDisconnectionDetail(List<org.altoro.core.metrics.net.DisconnectionDetailInfo> disconnectionDetail) {
