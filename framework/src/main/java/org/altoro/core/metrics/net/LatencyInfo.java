...
public class LatencyInfo {
  ...
  private int delay2S;
  private int delay3S;
  private List<org.altoro.core.metrics.net.LatencyDetailInfo> detail = new ArrayList<>();
  ...
  public List<org.altoro.core.metrics.net.LatencyDetailInfo> getDetail() {
    return detail;
  }

  public void setDetail(List<org.altoro.core.metrics.net.LatencyDetailInfo> detail) {
    this.detail = detail;
  }
}
