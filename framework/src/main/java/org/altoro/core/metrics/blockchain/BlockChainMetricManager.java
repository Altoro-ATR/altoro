package org.altoro.core.metrics.blockchain;
...
import org.altoro.core.metrics.net.RateInfo;
...
public class BlockChainMetricManager {
  ...
  public org.altoro.core.metrics.blockchain.BlockChainInfo getBlockChainInfo() {
    org.altoro.core.metrics.blockchain.BlockChainInfo blockChainInfo = new org.altoro.core.metrics.blockchain.BlockChainInfo();
    setBlockChainInfo(blockChainInfo);
    return blockChainInfo;
  }

  private void setBlockChainInfo(org.altoro.core.metrics.blockchain.BlockChainInfo blockChain) {
    ...
    List<org.altoro.core.metrics.blockchain.DupWitnessInfo> dupWitness = getDupWitness();
  ...
  public Protocol.MetricsInfo.BlockChainInfo getBlockChainProtoInfo() {
    ...
    org.altoro.core.metrics.blockchain.BlockChainInfo blockChain = getBlockChainInfo();
    ...
    for (org.altoro.core.metrics.blockchain.DupWitnessInfo dupWitness : blockChain.getDupWitness()) {
  ...
  private List<org.altoro.core.metrics.blockchain.DupWitnessInfo> getDupWitness() {
    List<org.altoro.core.metrics.blockchain.DupWitnessInfo> dupWitnesses = new ArrayList<>();
    ...
    for (Map.Entry<String, Counter> entry : dupWitnessMap.entrySet()) {
      org.altoro.core.metrics.blockchain.DupWitnessInfo dupWitness = new org.altoro.core.metrics.blockchain.DupWitnessInfo();
