...
public class HttpSelfFormatFieldName {
  ...
  static {
    ...
    AddressFieldNameMap.put("protocol.Delegate.address", 1);
    AddressFieldNameMap.put("protocol.Delegate.witnessAddress", 1);
    AddressFieldNameMap.put("protocol.DelegateAccount.delegate_address", 1);
    AddressFieldNameMap.put("protocol.DelegateAccount.owner_address", 1);

    AddressFieldNameMap.put("protocol.DelegateContract.owner_address", 1);
    AddressFieldNameMap.put("protocol.DelegateContract.delegate_address", 1);
    AddressFieldNameMap.put("protocol.UnDelegateContract.owner_address", 1);
    AddressFieldNameMap.put("protocol.UnDelegateContract.delegate_address", 1);
