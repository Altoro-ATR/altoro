...
public class Value {
  ...
  public Value(Object obj) {
    ...
    if (obj instanceof org.altoro.common.utils.Value) {
      this.value = ((org.altoro.common.utils.Value) obj).asObj();
    } else {
      this.value = obj;
    }
  }
  ...
  public org.altoro.common.utils.Value get(int index) {
    if (isList()) {
      // Guard for OutOfBounds
      if (asList().size() <= index) {
        return new org.altoro.common.utils.Value(null);
      }
      if (index < 0) {
        throw new RuntimeException("Negative index not allowed");
      }
      return new org.altoro.common.utils.Value(asList().get(index));
    }
  ...
  public boolean cmp(org.altoro.common.utils.Value o) {
  ...
  public String toString() {
    ...
    if (isList()) {
      ...
      if (list.length == 2) {
        ...
        org.altoro.common.utils.Value key = new org.altoro.common.utils.Value(list[0]);
        ...
        org.altoro.common.utils.Value val = new org.altoro.common.utils.Value(list[1]);
      ...
      for (int i = 0; i < list.length; ++i) {
        org.altoro.common.utils.Value val = new org.altoro.common.utils.Value(list[i]);
...
//        decode();
    if (this.isList()) {
      return this.asList().stream()
          .mapToInt(obj -> (new org.altoro.common.utils.Value(obj)).countBranchNodes())
          .sum();
