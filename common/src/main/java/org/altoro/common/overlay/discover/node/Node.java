...
public class Node implements Serializable {
  ...
  public static org.altoro.common.overlay.discover.node.Node instanceOf(String hostPort) {
    try {
      String[] sz = hostPort.split(":");
      int port = Integer.parseInt(sz[1]);
      return new org.altoro.common.overlay.discover.node.Node(org.altoro.common.overlay.discover.node.Node.getNodeId(), sz[0], port);
    } catch (Exception e) {
  ...
  public boolean equals(Object o) {
    ...
    if (o.getClass() == getClass()) {
      return StringUtils.equals(getIdString(), ((org.altoro.common.overlay.discover.node.Node) o).getIdString());
    }
