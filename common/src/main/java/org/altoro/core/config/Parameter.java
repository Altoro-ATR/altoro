...
public class Parameter {
  ...
  public class ChainConstant {
    ...
    public static final long DELEGATE_MAX_SIZE = 100L;
    public static final long DELEGATE_MIN_COUNT = 10000 * 1000_000L;
    public static final long REWARD_PRODUCTION_REDUCTION = 10_000_000L;
    public static final double REWARD_PRODUCTION_RATIO = 0.25;
