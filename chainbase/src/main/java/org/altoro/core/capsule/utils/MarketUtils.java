...
import org.altoro.core.capsule.MarketPriceCapsule;
...
import org.altoro.core.store.MarketAccountStore;
...
public class MarketUtils {
  ...
  public static boolean checkTokenValid(byte[] tokenId) {
    if (!Arrays.equals("_".getBytes(), tokenId) && !org.altoro.core.capsule.utils.TransactionUtil.isNumber(tokenId)) {
      return false;
    }
