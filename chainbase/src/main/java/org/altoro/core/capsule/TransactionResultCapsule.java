...
public class TransactionResultCapsule implements ProtoCapsule<Result> {
  ...
  public long getUnDelegateAmount() {
    return transactionResult.getUndelegateAmount();
  }

  public void setUnDelegateAmount(long amount) {
    this.transactionResult = this.transactionResult.toBuilder().setUndelegateAmount(amount).build();
  }
