...
import org.altoro.protos.Protocol.*;
import org.altoro.protos.Protocol.Account.AccountResource;
import org.altoro.protos.Protocol.Account.Builder;
...
public class AccountCapsule implements ProtoCapsule<Account>, Comparable<AccountCapsule> {
  ...
  public void clearDelegatedResource() {
    ...
    public long getDelegateFrozen() {
      return this.account.getDelegateFrozen();
    }

  public void addDelegateAccount(ByteString delegateAddress,ByteString ownerAddress, long delegateCount) {
    this.account = this.account.toBuilder()
            .addDelegate(DelegateAccount.newBuilder()
  ...
  public void addDelegateAccount(final Protocol.DelegateAccount delegateAccount) {
    this.account = this.account.toBuilder().addDelegate(delegateAccount).build();
  }
  ...
  public List<DelegateAccount> getDelegateList() {
    if (this.account.getDelegateList() != null) {
      return this.account.getDelegateList();
    } else {
      return Lists.newArrayList();
    }
  }
  ...
  public boolean getIsDelegate() {
    return getInstance().getIsDelegate();
  }

  public void setIsDelegate(boolean isDelegate) {
    this.account = this.account.toBuilder().setIsDelegate(isDelegate).build();
  }
