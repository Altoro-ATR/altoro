...
import org.altoro.core.capsule.ReceiptCapsule;
...
import org.altoro.protos.Protocol.TransactionInfo.code;
...
public class TransactionUtil {
  ...
  public static TransactionInfoCapsule buildTransactionInfoInstance(TransactionCapsule trxCap,
     ...
     * todo ******altoro******
     */
    builder.setUndelegateAmount(programResult.getRet().getUnDelegateAmount());
