...
import org.altoro.common.utils.ReflectUtils;
...
import org.altoro.protos.Protocol.Key;
import org.altoro.protos.Protocol.Permission;
import org.altoro.protos.Protocol.Permission.PermissionType;
import org.altoro.protos.Protocol.Transaction;
import org.altoro.protos.Protocol.Transaction.Contract.ContractType;
import org.altoro.protos.Protocol.Transaction.Result;
import org.altoro.protos.Protocol.Transaction.Result.contractResult;
import org.altoro.protos.Protocol.Transaction.raw;
...
import org.altoro.protos.contract.ShieldContract.ShieldedTransferContract;
import org.altoro.protos.contract.ShieldContract.SpendDescription;
...
import static org.altoro.common.utils.StringUtil.encode58Check;
import static org.altoro.common.utils.WalletUtil.checkPermissionOperations;
import static org.altoro.core.exception.P2pException.TypeEnum.PROTOBUF_ERROR;
...
public class TransactionCapsule implements ProtoCapsule<Transaction> {
  ...
  public TransactionCapsule(BalanceContract.DelegateRewardContract delegateRewardContract) {
    createTransaction(delegateRewardContract, ContractType.DelegateRewardContract);
  }

  public TransactionCapsule(WitnessContract.DelegateContract delegateContract) {
    createTransaction(delegateContract, ContractType.DelegateContract);
  }
