...
import org.altoro.protos.Protocol.MarketOrder.State;
import org.altoro.protos.contract.MarketContract.MarketSellAssetContract;
...
public class MarketOrderCapsule implements ProtoCapsule<MarketOrder> {
  ...
  public org.altoro.core.capsule.MarketOrderCapsule getPrevCapsule(MarketOrderStore orderStore) throws ItemNotFoundException {
    if (this.isPreNull()) {
      return null;
    } else {
  ...
  public org.altoro.core.capsule.MarketOrderCapsule getNextCapsule(MarketOrderStore orderStore) throws ItemNotFoundException {
    if (this.isNextNull()) {
      return null;
    } else {
