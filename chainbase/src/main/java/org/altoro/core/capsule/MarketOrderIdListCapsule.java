...
import org.altoro.core.store.MarketOrderStore;
import org.altoro.core.store.MarketPairPriceToOrderStore;
import org.altoro.protos.Protocol.MarketOrderIdList;
...
public class MarketOrderIdListCapsule implements ProtoCapsule<MarketOrderIdList> {
  ...
  public boolean isOrderExists(byte[] orderId, MarketOrderStore orderStore)
    ...
    while (currentOrderId.length != 0) {
      ...
      org.altoro.core.capsule.MarketOrderCapsule currentCapsule = orderStore.get(orderId);
  ...
  public void removeOrder(org.altoro.core.capsule.MarketOrderCapsule currentCapsule, MarketOrderStore marketOrderStore,
                          byte[] pairPriceKey, MarketPairPriceToOrderStore pairPriceToOrderStore)
      throws ItemNotFoundException {
    org.altoro.core.capsule.MarketOrderCapsule preCapsule = currentCapsule.getPrevCapsule(marketOrderStore);
    org.altoro.core.capsule.MarketOrderCapsule nextCapsule = currentCapsule.getNextCapsule(marketOrderStore);
  ...
  public void addOrder(org.altoro.core.capsule.MarketOrderCapsule currentCapsule, MarketOrderStore orderStore)
      throws ItemNotFoundException {
    ...
    if (this.isOrderEmpty()) {
      ...
      org.altoro.core.capsule.MarketOrderCapsule tailCapsule = orderStore.get(tailId);
  ...
  public org.altoro.core.capsule.MarketOrderCapsule getHeadOrder(MarketOrderStore marketOrderStore)
      throws ItemNotFoundException {
    if (this.isOrderEmpty()) {
      return null;
    }
  ...
  // just for test
  public org.altoro.core.capsule.MarketOrderCapsule getOrderByIndex(int index, MarketOrderStore marketOrderStore)
      throws ItemNotFoundException {
    if (this.isOrderEmpty()) {
      return null;
    }

    org.altoro.core.capsule.MarketOrderCapsule current = this.getHeadOrder(marketOrderStore);
  ...
  public int getOrderSize(MarketOrderStore marketOrderStore) throws ItemNotFoundException {
    ...
    org.altoro.core.capsule.MarketOrderCapsule head = marketOrderStore.get(this.getHead());
  ...
  public List<org.altoro.core.capsule.MarketOrderCapsule> getAllOrder(MarketOrderStore orderStore, long limit)
      throws ItemNotFoundException {

    List<org.altoro.core.capsule.MarketOrderCapsule> result = new ArrayList<>();

    long count = 0;
    byte[] orderId = this.getHead();
    if (!ByteArray.isEmpty(orderId)) {
      org.altoro.core.capsule.MarketOrderCapsule makerOrderCapsule = orderStore.getUnchecked(orderId);
